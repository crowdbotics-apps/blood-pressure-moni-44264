...
## Project Structure
    ...
    ├── blood_pressure_moni_44264  # Django project configurations
...
1. Clone this repo and `cd blood_pressure_moni_44264`
...
2. Clone this repo and `cd blood_pressure_moni_44264`
